...
TikTok only. At the niche search (phase 4) always ask, before the run and with its cost
($0.003 a page), whether the user also wants Instagram niche research along with TikTok;
a yes adds the Instagram hashtag door (`DOORS=photo,general,instagram`), a no runs TikTok
alone. A niche post then carries its platform; Instagram's niche
...
the keyword rounds (about $0.75 for a full phase 3), the niche search (about $0.03 on TikTok, about $0.09 with Instagram), a
